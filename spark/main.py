...
deployer.slave_instance_type = 'm4.4xlarge'
...
# spark-submit --packages ai.h2o:sparkling-water-core_2.11:2.1.7 --conf spark.dynamicAllocation.enabled=false --conf spark.maximizeResourceAllocation=true spark_main.py
